...
const TeamCard = ({ member }) => {
  return (
    <div className="relative h-[320px] w-[260px] flex-shrink-0 overflow-hidden rounded-2xl cursor-pointer shadow-lg group mx-4">
      ...
      {/* Content Reveal */}
      <div className="absolute bottom-0 left-0 w-full p-6 translate-y-12 group-hover:translate-y-0 transition-transform duration-500">
        ...
        <div className="flex gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200">
          ...
          {member.linkedin ? (
            ...
            <div className="p-2 bg-white/10 rounded-full hover:bg-[#0f8ddf] transition-colors text-white text-sm inline-flex items-center justify-center">
              <FaLinkedinIn />
            </div>
          )}

          {/* Twitter icon placeholder (kept decorative) */}
          {/* <div className="p-2 bg-white/10 rounded-full hover:bg-[#0f8ddf] transition-colors text-white text-sm inline-flex items-center justify-center">
            <FaTwitter />
          </div> */}
        </div>
...
export default function AboutSection() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      role: "Trainer",
      img: "/Team/Nitesh.jpg",
      linkedin: "https://www.linkedin.com/in/cresolnitesh",
    },
  ];
  ...
  return (
    <section className="relative w-full overflow-hidden bg-slate-50" style={{ fontFamily: "'Roboto', sans-serif" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-32">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <FadeIn direction="right">
            <div className="relative">
              <div className="absolute -left-4 -top-4 w-24 h-24 bg-blue-50 rounded-full -z-10" />
              <h2 className="text-4xl font-bold text-slate-900 mb-8">
                Our <span className="text-[#0f8ddf]">Story</span>
              </h2>
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed text-justify">
                <p>
                  Learners Digital was founded by <span className="text-[#0f8ddf] font-semibold">Murali Konareddy</span>, an{" "}
                  <span className="text-[#0f8ddf] font-semibold">IIT Kanpur alumnus</span> and former senior professional at{" "}
                  <span className="text-[#0f8ddf] font-semibold">Infosys</span>, together with a team of experienced colleagues from the company. The founding team brought a unique blend of delivery expertise and{" "}
                  <span className="text-[#0f8ddf] font-semibold">education & research leadership</span>, enabling Learners Digital to bridge academia and industry.
                </p>
                <p>
          ...
          <FadeIn direction="left" delay={200}>
            <div className="bg-white p-8 rounded-3xl shadow-[0_20px_50px_rgba(8,112,184,0.07)] border border-slate-100 relative overflow-hidden group hover:shadow-[0_20px_50px_rgba(8,112,184,0.12)] transition-all duration-500">
              ...
              <p className="text-lg text-slate-600 leading-relaxed text-justify mb-6">
                Today, <span className="text-[#0f8ddf] font-semibold">Learners Digital collaborates with corporates and academic institutions</span> to bridge the industry–academia gap. In the past four years alone, we have recruited and trained over <span className="text-[#0f8ddf] font-semibold">4,000 engineers</span> for our clients.
              </p>
        ...
        <FadeIn className="!mt-16">
          <div className="relative bg-[#0f172a] rounded-[2.5rem] p-8 md:p-16 overflow-hidden text-white">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#0f8ddf] rounded-full mix-blend-overlay filter blur-[100px] opacity-20 animate-pulse" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#e63950] rounded-full mix-blend-overlay filter blur-[100px] opacity-20 animate-pulse animation-delay-1000" />
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-4">
                ...
                <div className="h-1 w-20 bg-[#0f8ddf] rounded-full" />
              </div>
        ...
        <div className="!mt-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
                title: "Honorary Citizen of China",
                desc: "Conferred to Mr. Murali Mohan Konareddy by Joaxing Nahu District People's government.",
                color: "border-l-blue-500",
              },
              {
                title: "Extraordinary Mentor Award",
                desc: "Honored for outstanding dedication to guiding learners and inspiring innovation.",
                color: "border-l-indigo-500",
              },
              {
                title: "Founded Learners PU College",
                desc: "Established with a mission to bring world-class learning standards to pre-university education.",
                color: "border-l-purple-500",
              },
              {
                title: "Infosys Excellence Award",
                desc: "Awarded for outstanding contribution to talent development and workforce growth initiatives.",
                color: "border-l-pink-500",
              },
            ].map((item, i) => (
              <FadeIn key={`ach-${i}`} delay={i * 100}>
        ...
        <div className="!mt-16">
          ...
          <div className="relative w-full overflow-hidden">
            {/* Scroll track: we duplicate the team set to create seamless loop */}
          ...
          <div className="flex justify-center mt-16">
            <a href="/Careers" className="px-10 py-4 rounded-full font-bold text-white text-lg shadow-lg shadow-blue-500/30 bg-gradient-to-r from-[#0f8ddf] to-[#0077c8] hover:scale-105 hover:shadow-blue-500/50 transition-all duration-300">
              Join Our Team
            </a>
          </div>
        </div>
      ...
      {/* Scrolling CSS */}
      <style>{`
        /* Team scroller: the inner row is twice the content (we duplicated items) */
        .teamScroll {
          width: 100%;
          overflow: hidden;
        }
        ...
        .teamRow {
          ...
          gap: 1rem;
          width: max-content;
          /* animation moves the row left by 50% (one copy's width) */
          animation: scrollTeam 26s linear infinite;
        }

        /* pause on hover - also respected by tailwind hover utilities */
        .teamScroll:hover .teamRow {
        ...
        /* Make sure team cards remain visually consistent */
        .teamRow > div {
          /* the TeamCard root is a div; ensure it doesn't shrink */
          flex-shrink: 0;
        }

        /* Smaller screens: slightly faster scroll */
